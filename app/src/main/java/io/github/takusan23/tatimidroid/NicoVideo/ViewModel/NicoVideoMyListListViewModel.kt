...
/**
 * マイリストの動画を表示するFragment[io.github.takusan23.tatimidroid.NicoVideo.VideoList.NicoVideoMyListListFragment]で使うViewModel
 *
...
class NicoVideoMyListListViewModel(application: Application, private val myListId: String, private val isMe: Boolean) : AndroidViewModel(application) {
    ...
    /**
     * ソートする
     * @param sortNumber [io.github.takusan23.tatimidroid.NicoVideo.VideoList.NicoVideoMyListListFragment.initSortMenu]参照。
     * */
