...
/**
 * ニコレポ表示Fragment（[io.github.takusan23.tatimidroid.NicoVideo.VideoList.NicoVideoNicoRepoFragment]）で使うAdapter。
 *
 * 動画、生放送対応
 * */
class NicoRepoAdapter(val list: ArrayList<NicoRepoDataClass>) : RecyclerView.Adapter<NicoRepoAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        holder.apply {
            ...
            titleTextView.text = HtmlCompat.fromHtml(item.message, HtmlCompat.FROM_HTML_MODE_COMPACT)
